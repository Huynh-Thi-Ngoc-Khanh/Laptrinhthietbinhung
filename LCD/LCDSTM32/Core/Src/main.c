...
void send8BitLCD(char D){
	//Dem D and so hoc voi 2^i de biet bit thu i=0 hay khac 0
	//tim gia tri cac bit
...
void sendCMD2LCD(char cmd){
	//B1. Done
	//B2. Dat chan RS=0, de noi rang cmd la lenh
...
int main(void)
{
	...
	sendString2LCD("Hello K60 NTU");
	//Xuong dong 2
	sendCMD2LCD(0x38);	//CHE DO 2 DONG
	sendCMD2LCD(0xC0);	//TRO XUONG DONG 2
	
	//sendString2LCD("HUYNH THI NGOC KHANH - NTU");
    while (1)
  {
